package com.wb.lib_weiget.views;
...
import com.wb.lib_weiget.R;
import com.wb.lib_weiget.interfaces.OnTabSelectListener;
import com.wb.lib_weiget.utils.UnreadMsgUtils;
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorGravity == Gravity.BOTTOM) {
                    ...
                    if (mIndicatorIsTop) {
                        ...
                        mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                                height - (int) mIndicatorHeight - (int) mIndicatorMarginBottom - dp2px(9),
                                paddingLeft + mIndicatorRect.right - (int) mIndicatorMarginRight,
                                height - (int) mIndicatorMarginBottom - dp2px(9));
                    } else {
                        mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
